function solve(input) {
    ...
    if (groupEnergy <= 0) {     
        console.log(`You will run out of energy. You will be left with ${food.toFixed(2)} food and ${water} water.`);
    } else {                   
        console.log(`You are ready for the quest. You will be left with - ${groupEnergy.toFixed(2)} energy!`)
    }
}
solve(['10', '7', '5035.5', '11.3', '7.2', '942.3', '500.57', '520.68', '540.87', '505.99',
    '630.3', '784.20', '321.21', '456.8', '330',]);
